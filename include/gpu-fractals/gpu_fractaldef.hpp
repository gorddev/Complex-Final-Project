...
// namespace of gpu fractals
namespace gan::gpu_f {
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // ~~~~~~~~~~~~~ Fractal Creation ~~~~~~~~~~~~~~~~
    inline constexpr float maxZoom = 12.f;
    inline constexpr int totalFractalNum = 10;
    ...
    inline constexpr GPUFractalInfo fractalInfo[totalFractalNum] = {
        ...
        /* Lambda */
        {"λ·Exp[z]", "gpu_shaders/lambda.frag",
            // Description
            ...
            // Uniforms
            {
            {"λ (x + yi)", "uLambda", VEC2, {0.1f, 1.f}, UniformData(0.4f, 0.0f), 0.025f},
            {"Escape Velocity²", "uEscapeVelocity", FLOAT, {30.f, 1000.f}, UniformData(100.f)}
            },
        },

        /* Lambda */
        {"λ·sin(z)", "gpu_shaders/lambda_sin.frag",
            // Description
            "The lambda (λ) fractal repeatedly applies the formula:\n"
            "    λ · sin(z)\n"
            "Isn't that neat?",
            // Uniforms
            {
            {"λ (x + yi)", "uLambda", VEC2, {0.0f, 1.5f}, UniformData(0.803f, 0.607143f), 0.025f},
            {"Escape Velocity²", "uEscapeVelocity", FLOAT, {30.f, 1000.f}, UniformData(100.f)}
            },
        },
