...
// include: /var/folders/rm/hj_cdjp17xjcbpkc4gpcycnc0000gn/T/tmp0yewqx1c.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'fractal.data';
      var REMOTE_PACKAGE_BASE = 'fractal.data';
...
Module['FS_createPath']("/shaders", "gpu_shaders", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_fractal.data');
      }
      Module['addRunDependency']('datafile_fractal.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/JetbrainsMono.ttf", "start": 0, "end": 130128}, {"filename": "/shaders/cpu.frag", "start": 130128, "end": 130201}, {"filename": "/shaders/gpu_shaders/burn_ship.frag", "start": 130201, "end": 132673}, {"filename": "/shaders/gpu_shaders/burn_ship_inv.frag", "start": 132673, "end": 135145}, {"filename": "/shaders/gpu_shaders/cursorbrot.frag", "start": 135145, "end": 137677}, {"filename": "/shaders/gpu_shaders/default.frag", "start": 137677, "end": 139940}, {"filename": "/shaders/gpu_shaders/julia.frag", "start": 139940, "end": 143334}, {"filename": "/shaders/gpu_shaders/lambda.frag", "start": 143334, "end": 145851}, {"filename": "/shaders/gpu_shaders/lambda_sin.frag", "start": 145851, "end": 148718}, {"filename": "/shaders/gpu_shaders/mandelbrot.frag", "start": 148718, "end": 151250}, {"filename": "/shaders/gpu_shaders/multibrot_float.frag", "start": 151250, "end": 154094}, {"filename": "/shaders/gpu_shaders/multibrot_int.frag", "start": 154094, "end": 156943}, {"filename": "/shaders/gpu_shaders/nova.frag", "start": 156943, "end": 160240}, {"filename": "/shaders/std.vert", "start": 160240, "end": 160402}], "remote_package_size": 160402});

  })();

// end include: /var/folders/rm/hj_cdjp17xjcbpkc4gpcycnc0000gn/T/tmp0yewqx1c.js
// include: /var/folders/rm/hj_cdjp17xjcbpkc4gpcycnc0000gn/T/tmpoe9layo6.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/rm/hj_cdjp17xjcbpkc4gpcycnc0000gn/T/tmpoe9layo6.js
...
// include: /var/folders/rm/hj_cdjp17xjcbpkc4gpcycnc0000gn/T/tmpdu1jkc69.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/rm/hj_cdjp17xjcbpkc4gpcycnc0000gn/T/tmpdu1jkc69.js
...
function findWasmBinary() {
  return locateFile('fractal.wasm');
}
...
/** @type {function(string, boolean=, number=)} */
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(5, 0, 1, buf, size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(11, 0, 1, which, timeout_ms);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(14, 0, 1, target, width, height);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(15, 0, 1);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(17, 0, 1, target, width, height);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(18, 0, 1, fullscreenStatus);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(19, 0, 1, index, gamepadState);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(21, 0, 1, width, height);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(22, 0, 1, target, deferUntilInEventHandler, fullscreenStrategy);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(23, 0, 1, target, deferUntilInEventHandler);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(24, 0, 1);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(25, 0, 1, userData, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(28, 0, 1, target, width, height);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(30, 0, 1, target, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(31, 0, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(32, 0, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(36, 0, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(38, 0, 1, target, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(41, 0, 1, title);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(42, 0, 1, __environ, environ_buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(43, 0, 1, penviron_count, penviron_buf_size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(44, 0, 1, fd);
...
var _CallSDLEmscriptenMainFunction = Module['_CallSDLEmscriptenMainFunction'] = makeInvalidEarlyAccess('_CallSDLEmscriptenMainFunction');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['CallSDLEmscriptenMainFunction'] != 'undefined', 'missing Wasm export: CallSDLEmscriptenMainFunction');
  ...
  _CallSDLEmscriptenMainFunction = Module['_CallSDLEmscriptenMainFunction'] = createExportWrapper('CallSDLEmscriptenMainFunction', 3);
...
// include: /Users/gordie/emsdk/upstream/emscripten/src/emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
...
// end include: /Users/gordie/emsdk/upstream/emscripten/src/emrun_postjs.js
